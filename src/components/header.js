...
const Header = () => (
  <Nav>
    ...
    <div className="block mr-4 lg:hidden">
      <button className="flex items-center px-3 py-2 border rounded border-white hover:text-white hover:border-black">
        <svg className="fill-current h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" /></svg>
      </button>
    </div>
    <LinkContainer>
      <div className="flex flex-col items-end mr-2 lg:w-1/4 lg:flex-row lg:justify-around">
